...
def plot_target_boxplot_by_station(df, station_col, target_col, top_k, out_dir) -> str:
    """A3: Boxplot of target by station (top_k stations by rows)."""
...
def parse_args(argv=None):
    ...
    # New: per-station time-series for A1
    p.add_argument(
...
def main(argv=None):
    ...
    created["A3_boxplot"] = plot_target_boxplot_by_station(df, cols["station_col"], target_col, args.boxplot_top_k, out_dir)
